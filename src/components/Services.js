...
export default function Services() {
  return (
    <div id='services' className='text-white text-center'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3  sm:grid-cols-2 lg:grid-cols-3 p-2 '>
        <div className='w-5/6 mx-auto relative pb-2 services_box h-auto hover:bg-blue-950 rounded-b-2xl'>
          <div className='w-full rounded-b-2xl  bg-blue-500  relative'>
            <h1 className='py-4'>UI/UX Design</h1><GiClick size={20} className=' absolute top-3 right-3'/>
          </div>
        ...
        <div className='w-5/6 mx-auto relative pb-2 services_box h-auto hover:bg-blue-950 rounded-b-2xl'>
          <div className='w-full rounded-b-2xl  bg-blue-500 relative'>
            <h1 className='py-4'>Web/Mobile Development</h1><GiClick size={20} className=' absolute top-3 right-3'/>
          </div>
          <div className='services_item '>
        ...
        <div className='w-5/6 mx-auto relative pb-2 services_box h-auto hover:bg-blue-950 rounded-b-2xl'>
          <div className='w-full rounded-b-2xl  bg-blue-500 relative '>
            <h1 className='py-4'>Content Creation</h1><GiClick size={20} className=' absolute top-3 right-3'/>
          </div>
          <div className='services_item '>
