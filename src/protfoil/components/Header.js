...
export default function Header() {
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 p-2 text-white text-center w-[100vw]'>
      <div className='relative'>
        ...
        <div className='relative'>
          <h1 className="metalHeader w-full text-xs md:text-xl absolute md:left-[15%] md:top-24 top-16">
      ...
      <div className='grid grid-cols-1 md:grid-cols-2'>
        ...
        <div className='grid grid-rows-3 md:px-8 py-3 gap-4 font-extrabold md:text-center'>
          <a href='/' className='md:ml-auto'><FiGithub size={"2rem"} /></a>
          <a href='/' className='md:ml-auto'><FiLinkedin size={"2rem"} /></a>
          <a href='/' className='md:ml-auto'><FiDribbble size={"2rem"} /></a>
        </div>
      </div>
    </div>
  );
